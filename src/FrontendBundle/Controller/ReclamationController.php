...
use FrontendBundle\Form\Type\ReclamationType;
use FrontendBundle\Form\Type\ReclamationFilterType;
...
class ReclamationController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $qb = $em->getRepository('FrontendBundle:Reclamation')->createQueryBuilder('r');
        $paginator = $this->filter($request,$form, $qb, 'reclamation');
                return $this->render('FrontendBundle:Reclamation:index.html.twig', array(
    ...
    public function showAction(Reclamation $reclamation)
    {
        ...
        return $this->render('FrontendBundle:Reclamation:show.html.twig', array(
    ...
    public function newAction()
    {
        ...
        return $this->render('FrontendBundle:Reclamation:new.html.twig', array(
            'reclamation' => $reclamation,
            'form'   => $form->createView(),
        ));
    }
    ...
    public function editAction(Reclamation $reclamation)
    {
        ...
        return $this->render('FrontendBundle:Reclamation:edit.html.twig', array(
            'reclamation' => $reclamation,
