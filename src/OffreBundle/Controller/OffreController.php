...
use OffreBundle\Form\Type\OffreType;
use OffreBundle\Form\Type\OffreFilterType;
...
class OffreController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $qb = $em->getRepository('OffreBundle:Offre')->createQueryBuilder('o');
    ...
    {
        $this->setOrder($request,'offre', $field, $type);
