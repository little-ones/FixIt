...
class DemandeControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $crawler = $client->request('GET', '/DemandeClientAdmin/');
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'demande[titre]' => 'Lorem ipsum dolor sit amet',
            'demande[budget]' => 'Lorem ipsum dolor sit amet',
            'demande[description]' => 'Lorem ipsum dolor sit amet',
            'demande[date]' => new \DateTime(),
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/DemandeClientAdmin/new');
    ...
    public function testEdit()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'demande[titre]' => 'Changed',
            'demande[budget]' => 'Changed',
            'demande[description]' => 'Changed',
            'demande[date]' => new \DateTime(),
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'demande_filter[titre]' => 'First%',
            'demande_filter[budget]' => 'First%',
            'demande_filter[description]' => 'First%',
            'demande_filter[date]' => new \DateTime(),
