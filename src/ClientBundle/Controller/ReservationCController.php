...
class ReservationCController extends Controller
{
    ...
    public function ajouterAction(Request $request , $id)
    {
        ...
        $reservation->setIdPro($offre->getUser());
    ...
    public function ListReservationAction()
    {
        ...
        return $this->render('@Client/Reservation/mesreservation.html.twig',array(
            'reservation'=>$reservation,'usrname'=>$user,
            'etat'=>$etat));
    }
