...
namespace ProBundle\Tests\Controller;
...
class OffreControllerTest extends WebTestCase
{
    public function testCreate()
    {
        ...
        $form = $crawler->filter('form button[type="submit"]')->form(array(
            'offre[dateAjout]' => new \DateTime(),
            'offre[budget]' => 42,
            'offre[Titre]' => 'Lorem ipsum dolor sit amet',
            'offre[Description]' => 'Lorem ipsum dolor sit amet',
                    ));
        $client->submit($form);
    ...
    {
        $client = static::createClient();
        $crawler = $client->request('GET', '/offre/new');
    ...
    public function testFilter()
    {
        ...
        $form = $crawler->filter('div#filter form button[type="submit"]')->form(array(
            'offre_filter[dateAjout]' => new \DateTime(),
            'offre_filter[budget]' => 42,
            'offre_filter[Titre]' => 'First%',
            'offre_filter[Description]' => 'First%',
