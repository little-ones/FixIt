...
use ServiceBundle\Form\Type\ServiceType;
use ServiceBundle\Form\Type\ServiceFilterType;
...
class ServiceController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $qb = $em->getRepository('ServiceBundle:Service')->createQueryBuilder('s');
        $paginator = $this->filter($request,$form, $qb, 'service');
                return $this->render('ServiceBundle:Service:index.html.twig', array(
    ...
    public function showAction(Service $service)
    {
        ...
        return $this->render('ServiceBundle:Service:show.html.twig', array(
            'service' => $service,
    ...
    public function newAction()
    {
        ...
        return $this->render('ServiceBundle:Service:new.html.twig', array(
            'service' => $service,
            'form'   => $form->createView(),
        ));
    }
    ...
    public function editAction(Service $service)
    {
        ...
        return $this->render('ServiceBundle:Service:edit.html.twig', array(
            'service' => $service,
